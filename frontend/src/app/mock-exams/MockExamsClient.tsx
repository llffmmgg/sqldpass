  ...
  return (
    <Link href={href} className="group relative block">
      <Card
        ...
        className={
          isPremium
            ? "relative flex min-h-[124px] flex-col overflow-hidden rounded-md border-amber-500/15 p-4 shadow-none outline outline-1 outline-amber-500/55 outline-offset-[-8px] hover:-translate-y-0 hover:border-amber-500/25 hover:shadow-none hover:outline-amber-500/80"
