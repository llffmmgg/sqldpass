        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {certs.map((cert) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-xl border border-border bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/40 hover:shadow-[0_0_24px_var(--glow)]"
            >
