    ...
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-28 text-center sm:px-6 sm:py-36 lg:px-8">
          ...
          <ScrollReveal delay={2}>
            <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
              자격증 시험을 실제 CBT 환경 그대로.
              <br className="hidden sm:block" />
              매번 새로 구성되는 모의고사 · 오답 자동 복습 · 회차별 실력 추적.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal delay={5}>
            <div className="mt-10 flex items-center justify-center gap-5 text-sm text-muted">
      ...
      <section className="mx-auto max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-3">
          <ScrollReveal delay={1}>
            <div className="group relative h-full rounded-xl border border-border bg-surface p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-amber-500/30 hover:shadow-[0_0_24px_var(--glow)]">
          ...
          <ScrollReveal delay={2}>
            <div className="group relative h-full rounded-xl border border-border bg-surface p-6 transition-all duration-300 hover:-translate-y-1.5 hover:border-violet-500/30 hover:shadow-[0_0_24px_var(--accent-glow)] lg:-translate-y-2">
              <span className="pointer-events-none absolute right-4 top-4 select-none text-[64px] font-bold leading-none text-foreground/[0.03]">
                02
              </span>
