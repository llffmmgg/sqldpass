...
export function SiteNoticeBanner() {
  ...
  return (
    <div className="flex items-start justify-between gap-3 border-b border-primary/30 bg-primary/10 px-4 py-2.5 text-left text-sm font-medium text-foreground sm:items-center sm:justify-center sm:text-center">
      ...
      <button
        ...
        onClick={dismiss}
        aria-label="닫기"
        className="mt-0.5 shrink-0 rounded p-1 text-foreground/70 hover:bg-primary/15 hover:text-foreground sm:mt-0"
      >
