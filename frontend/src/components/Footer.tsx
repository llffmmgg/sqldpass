      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div data-nosnippet className="mt-10 border-t border-border pt-6">
          ...
          <details className="group mt-4">
            <summary className="cursor-pointer list-none text-[11px] font-medium text-text-muted transition-colors hover:text-text">
            ...
            <dl className="mt-3 grid grid-cols-1 gap-x-6 gap-y-1 text-[11px] leading-relaxed text-text-subtle sm:grid-cols-2">
