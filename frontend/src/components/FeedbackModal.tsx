      ...
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6">
        ...
        {!loggedIn ? (
          <div className="mt-6 text-center">
            <p className="text-sm text-muted">피드백을 보내려면 로그인이 필요합니다.</p>
            <button
              onClick={handleLogin}
              className="mt-4 inline-flex items-center gap-2 rounded-lg border border-border bg-white px-5 py-2.5 text-sm font-semibold text-zinc-800 transition hover:shadow-lg"
            >
          ...
          <>
                    ...
                    <button
                      ...
                      className={`rounded-lg border px-3 py-2 text-sm font-medium transition ${
                        isActive
                          ...
                          : "border-border text-muted hover:border-amber-500/30 hover:text-foreground"
                      }`}
                    >
                      {opt.label}
                    </button>
            ...
            <div className="mt-5 flex justify-end gap-2">
              ...
              <button
                ...
                className="rounded-lg bg-primary px-5 py-2 text-sm font-semibold text-zinc-900 transition hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-40"
              >
